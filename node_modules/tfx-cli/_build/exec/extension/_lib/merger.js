...
var Merger = (function () {
    ...
    Merger.prototype.pathToFileDeclarations = function (fsPath, root, fileDecl) {
        ...
        if (fs.lstatSync(fsPath).isDirectory()) {
            ...
            var partName = "/" + relativePath;
            if (fileDecl.partName || fileDecl.packagePath) {
                partName = utils_1.toZipItemName(utils_1.forwardSlashesPath(_.trimEnd(fileDecl.partName || fileDecl.packagePath, "/") + relativePath.substr(fileDecl.path.length)));
            }
            files.push({
                path: relativePath,
                partName: partName,
